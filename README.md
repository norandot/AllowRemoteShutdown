...
* 本ツールの利用は自己責任で行ってください。本ツールの使用によるデータの損失、ハードウェアの故障、その他損害について作者は一切の責任を負いません。  
* psshutdown.exe の著作権およびライセンスは Microsoft Sysinternals に帰属します。ツール自体のライセンス条項に従って利用してください。
